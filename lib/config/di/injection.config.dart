...
import '../../core/data/network/network.dart' as _i7;
import '../../feature/detail/data/datasource/datasource.dart' as _i14;
import '../../feature/detail/data/datasource/detail_remote_datasource.dart'
    as _i6;
import '../../feature/detail/domain/repository/detail_repository.dart' as _i13;
import '../../feature/detail/domain/repository/repository.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i6.DetailRemoteDataSource>(
        () => _i6.DetailRemoteDataSourceImpl(client: gh<_i7.ApiClient>()));
    gh.lazySingleton<_i8.HomeRepository>(() => _i8.HomeRepositoryImpl(
        remoteDataSource: gh<_i9.HomeRemoteDataSource>()));
    gh.lazySingleton<_i10.GetTopRatedMoviesUseCase>(
        () => _i10.GetTopRatedMoviesUseCase(gh<_i8.HomeRepository>()));
    gh.factory<_i11.HomeCubit>(
        () => _i11.HomeCubit(gh<_i12.GetTopRatedMoviesUseCase>()));
    gh.lazySingleton<_i13.DetailRepository>(() => _i13.DetailRepositoryImpl(
        remoteDataSource: gh<_i14.DetailRemoteDataSource>()));
    gh.lazySingleton<_i15.GetMovieDetailUseCase>(
        () => _i15.GetMovieDetailUseCase(gh<_i16.DetailRepository>()));
    gh.factory<_i17.DetailCubit>(
        () => _i17.DetailCubit(gh<_i18.GetMovieDetailUseCase>()));
    return this;
  }
}
